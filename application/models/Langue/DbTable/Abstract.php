 ...
 * @version $Id$
 *
 * @method Application_Model_Langue_Row createRow(array $data, string $defaultSource = null)
 * @method Application_Model_Langue_Rowset fetchAll(string|array|Zend_Db_Table_Select $where = null, string|array $order = null, int $count = null, int $offset = null)
 * @method Application_Model_Langue_Row fetchRow(string|array|Zend_Db_Table_Select $where = null, string|array $order = null, int $offset = null)
 * @method Application_Model_Langue_Rowset find()
 *
 */
abstract class Application_Model_Langue_DbTable_Abstract extends Zend_Db_Table_Abstract
{
    /**
     * @var string
     */
  ...
  0 => 'Application_Model_Media_DbTable',
     ...
     * @var string
     */
    protected $_rowClass = 'Application_Model_Langue_Row';

    /**
     * @var string
     */
    protected $_rowsetClass = 'Application_Model_Langue_Rowset';
  ...
  'pays' => NULL,
    ...
    public function getDbSelectByParams($params = array(), $sortField = '', $sortOrder = '')
    {
        ...
        if (isset($params['_kw']) && !empty($params['_kw'])) {
            ...
            if ('all' === $searchMode || 'pays' === $searchMode) {
                $searchWheres[] = $dbAdapter->quoteInto('pays LIKE ?', "%$keywords%");
            }
