 ...
 * @version $Id$
 *
 * @method Application_Model_Notification_Row createRow(array $data, string $defaultSource = null)
 * @method Application_Model_Notification_Rowset fetchAll(string|array|Zend_Db_Table_Select $where = null, string|array $order = null, int $count = null, int $offset = null)
 * @method Application_Model_Notification_Row fetchRow(string|array|Zend_Db_Table_Select $where = null, string|array $order = null, int $offset = null)
 * @method Application_Model_Notification_Rowset find()
 *
 */
abstract class Application_Model_Notification_DbTable_Abstract extends Zend_Db_Table_Abstract
{
    /**
     * @var string
     */
  ...
  0 => 'id',
    ...
    protected $_referenceMap = array(        
        'id_user' => array(
            'columns' => 'id_user',
            'refTableClass' => 'Application_Model_Users_DbTable',
            'refColumns' => 'username'
        ),
     ...
     * @var string
     */
    protected $_rowClass = 'Application_Model_Notification_Row';

    /**
     * @var string
     */
    protected $_rowsetClass = 'Application_Model_Notification_Rowset';
