...
--
-- Client: localhost
-- Généré le: Jeu 10 Janvier 2013 à 16:25
...
(39, '10010001', 2, '1234567891311', 'Podor', '77 432 1234', '2013-01-10', '1001', '1001', 'Assane', 'Diop', 1, '1985-02-01', 'Podor', 'Diossong');
...
('def', 'daral', 'animal', 'fk_id_farmer', 2, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'daral', 'animal', 'fk_animaltype', 3, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'daral', 'animal', 'photo_left', 4, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'daral', 'animal', 'photo_right', 5, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'daral', 'animal', 'photo_front', 6, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
...
('def', 'daral', 'farmer', 'id_localite', 15, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', 'MUL', '', 'select,insert,update,references', ''),
...
('def', 'daral', 'localite', 'region', 4, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', 'MUL', '', 'select,insert,update,references', ''),
...
('def', 'daral', 'users', 'username', 2, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', 'UNI', '', 'select,insert,update,references', ''),
('def', 'daral', 'users', 'password', 3, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
...
('COM_SHOW_SLAVE_STATUS', '24'),
('COM_SHOW_STATUS', '0'),
('COM_SHOW_STORAGE_ENGINES', '0'),
('COM_SHOW_TABLE_STATUS', '294'),
('COM_SHOW_TABLES', '50'),
('COM_SHOW_TRIGGERS', '216'),
('COM_SHOW_VARIABLES', '106'),
('COM_SHOW_WARNINGS', '0'),
('COM_SLAVE_START', '0'),
('COM_SLAVE_STOP', '0'),
('COM_STMT_CLOSE', '0'),
...
('COMPRESSION', 'OFF'),
('CONNECTIONS', '423'),
('CREATED_TMP_DISK_TABLES', '842'),
('CREATED_TMP_FILES', '5'),
('CREATED_TMP_TABLES', '1516'),
('DELAYED_ERRORS', '0'),
...
('HANDLER_DISCOVER', '0'),
('HANDLER_PREPARE', '0'),
('HANDLER_READ_FIRST', '605'),
('HANDLER_READ_KEY', '1121'),
('HANDLER_READ_LAST', '0'),
('HANDLER_READ_NEXT', '2058'),
('HANDLER_READ_PREV', '0'),
('HANDLER_READ_RND', '2'),
('HANDLER_READ_RND_NEXT', '15000'),
('HANDLER_ROLLBACK', '2'),
('HANDLER_SAVEPOINT', '0'),
('HANDLER_SAVEPOINT_ROLLBACK', '0'),
('HANDLER_UPDATE', '4'),
('HANDLER_WRITE', '12697'),
('INNODB_BUFFER_POOL_PAGES_DATA', '649'),
('INNODB_BUFFER_POOL_PAGES_DIRTY', '0'),
('INNODB_BUFFER_POOL_PAGES_FLUSHED', '1775'),
('INNODB_BUFFER_POOL_PAGES_FREE', '7541'),
('INNODB_BUFFER_POOL_PAGES_MISC', '2'),
('INNODB_BUFFER_POOL_PAGES_TOTAL', '8192'),
('INNODB_BUFFER_POOL_READ_AHEAD_RND', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '129595'),
('INNODB_BUFFER_POOL_READS', '485'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '35473'),
('INNODB_DATA_FSYNCS', '815'),
('INNODB_DATA_PENDING_FSYNCS', '0'),
('INNODB_DATA_PENDING_READS', '0'),
('INNODB_DATA_PENDING_WRITES', '0'),
('INNODB_DATA_READ', '10129408'),
('INNODB_DATA_READS', '495'),
('INNODB_DATA_WRITES', '1248'),
('INNODB_DATA_WRITTEN', '60461056'),
('INNODB_DBLWR_PAGES_WRITTEN', '1775'),
('INNODB_DBLWR_WRITES', '49'),
('INNODB_HAVE_ATOMIC_BUILTINS', 'ON'),
('INNODB_LOG_WAITS', '0'),
('INNODB_LOG_WRITE_REQUESTS', '4645'),
('INNODB_LOG_WRITES', '697'),
('INNODB_OS_LOG_FSYNCS', '716'),
('INNODB_OS_LOG_PENDING_FSYNCS', '0'),
('INNODB_OS_LOG_PENDING_WRITES', '0'),
('INNODB_OS_LOG_WRITTEN', '2288128'),
('INNODB_PAGE_SIZE', '16384'),
('INNODB_PAGES_CREATED', '165'),
('INNODB_PAGES_READ', '484'),
('INNODB_PAGES_WRITTEN', '1775'),
...
('INNODB_ROWS_INSERTED', '1026'),
('INNODB_ROWS_READ', '4167'),
...
('THREADS_RUNNING', '1'),
('UPTIME', '4683'),
('UPTIME_SINCE_FLUSH_STATUS', '4683');
...
('def', 'daral', 'farmer_ibfk_14', 'def', 'daral', 'farmer', 'id_localite', 1, 1, 'daral', 'localite', 'name'),
...
('def', 'daral', 'localite_ibfk_2', 'def', 'daral', 'localite', 'region', 1, 1, 'daral', 'region', 'name'),
...
('def', 'daral', 'notification_ibfk_18', 'def', 'daral', 'notification', 'id_farmer', 1, 1, 'daral', 'farmer', 'id_farmer'),
('def', 'daral', 'notification_ibfk_19', 'def', 'daral', 'notification', 'id_localite', 1, 1, 'daral', 'localite', 'id'),
('def', 'daral', 'notification_ibfk_20', 'def', 'daral', 'notification', 'type', 1, 1, 'daral', 'typenotification', 'id'),
('def', 'daral', 'notification_ibfk_21', 'def', 'daral', 'notification', 'id_user', 1, 1, 'daral', 'users', 'id'),
...
('def', 'information_schema', 'CHARACTER_SETS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 384, 0, 16434816, 0, 0, '2013-01-10 15:25:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 231, 0, 16704765, 0, 0, '2013-01-10 15:25:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 195, 0, 16357770, 0, 0, '2013-01-10 15:25:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2013-01-10 15:25:44', '2013-01-10 15:25:44', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMN_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2565, 0, 16757145, 0, 0, '2013-01-10 15:25:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ENGINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 490, 0, 16574250, 0, 0, '2013-01-10 15:25:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'EVENTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2013-01-10 15:25:44', '2013-01-10 15:25:44', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'FILES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2677, 0, 16758020, 0, 0, '2013-01-10 15:25:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2013-01-10 15:25:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2013-01-10 15:25:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'KEY_COLUMN_USAGE', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4637, 0, 16762755, 0, 0, '2013-01-10 15:25:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARAMETERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2013-01-10 15:25:44', '2013-01-10 15:25:44', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARTITIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2013-01-10 15:25:44', '2013-01-10 15:25:44', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PLUGINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2013-01-10 15:25:44', '2013-01-10 15:25:44', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROCESSLIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2013-01-10 15:25:44', '2013-01-10 15:25:44', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROFILING', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 308, 0, 16562084, 0, 0, '2013-01-10 15:25:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4814, 0, 16767162, 0, 0, '2013-01-10 15:25:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ROUTINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2013-01-10 15:25:44', '2013-01-10 15:25:44', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMATA', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3464, 0, 16738048, 0, 0, '2013-01-10 15:25:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2179, 0, 16736899, 0, 0, '2013-01-10 15:25:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2013-01-10 15:25:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2013-01-10 15:25:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'STATISTICS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 5753, 0, 16752736, 0, 0, '2013-01-10 15:25:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9450, 0, 16764300, 0, 0, '2013-01-10 15:25:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLESPACES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 6951, 0, 16772763, 0, 0, '2013-01-10 15:25:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2504, 0, 16721712, 0, 0, '2013-01-10 15:25:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2372, 0, 16748692, 0, 0, '2013-01-10 15:25:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TRIGGERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2013-01-10 15:25:44', '2013-01-10 15:25:44', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'USER_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 1986, 0, 16726092, 0, 0, '2013-01-10 15:25:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'VIEWS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2013-01-10 15:25:44', '2013-01-10 15:25:44', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 13107200, 0, 0, '2013-01-10 15:25:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_TRX', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4534, 0, 16766732, 0, 0, '2013-01-10 15:25:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2013-01-10 15:25:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCK_WAITS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 599, 0, 16749238, 0, 0, '2013-01-10 15:25:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2013-01-10 15:25:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 13107200, 0, 0, '2013-01-10 15:25:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCKS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 31244, 0, 16746784, 0, 0, '2013-01-10 15:25:44', NULL, NULL, NULL, '', '', NULL),
('def', 'daral', 'animal', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 32768, 11534336, '2013-01-10 15:15:59', NULL, NULL, NULL, '', '', NULL),
('def', 'daral', 'animaltype', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 8192, 16384, NULL, 16384, 11534336, '2013-01-10 15:14:55', NULL, NULL, NULL, '', '', NULL),
('def', 'daral', 'categorie', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 8192, 16384, NULL, 16384, 11534336, '2013-01-10 15:14:55', NULL, NULL, NULL, '', '', NULL),
('def', 'daral', 'cheptel', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 32768, 11534336, '2013-01-10 15:15:59', NULL, NULL, NULL, '', '', NULL),
('def', 'daral', 'daral', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 7, 2340, 16384, NULL, 32768, 11534336, '2013-01-10 15:15:59', NULL, NULL, NULL, '', '', NULL),
('def', 'daral', 'daralstatanimal', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 32768, 11534336, '2013-01-10 15:15:59', NULL, NULL, NULL, '', '', NULL),
('def', 'daral', 'daralstatfarmer', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 16384, 11534336, '2013-01-10 15:16:00', NULL, NULL, NULL, '', '', NULL),
('def', 'daral', 'departement', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 45, 364, 16384, NULL, 32768, 11534336, '2013-01-10 15:16:00', NULL, NULL, NULL, '', '', NULL),
('def', 'daral', 'departementstatanimal', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 32768, 11534336, '2013-01-10 15:16:00', NULL, NULL, NULL, '', '', NULL),
('def', 'daral', 'departementstatfarmer', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 16384, 11534336, '2013-01-10 15:16:00', NULL, NULL, NULL, '', '', NULL),
('def', 'daral', 'farmer', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 5461, 16384, NULL, 81920, 11534336, '2013-01-10 15:16:00', NULL, NULL, NULL, '', '', NULL),
('def', 'daral', 'langue', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 16384, 11534336, '2013-01-10 15:14:56', NULL, NULL, NULL, '', '', NULL),
('def', 'daral', 'localite', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 7, 2340, 16384, NULL, 49152, 11534336, '2013-01-10 15:16:00', NULL, NULL, NULL, '', '', NULL),
('def', 'daral', 'localitestatanimal', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 32768, 11534336, '2013-01-10 15:16:01', NULL, NULL, NULL, '', '', NULL),
('def', 'daral', 'localitestatfarmer', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 16384, 11534336, '2013-01-10 15:16:01', NULL, NULL, NULL, '', '', NULL),
('def', 'daral', 'maladie', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 16384, 11534336, '2013-01-10 15:14:57', NULL, NULL, NULL, '', '', NULL),
('def', 'daral', 'media', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 32768, 11534336, '2013-01-10 15:16:01', NULL, NULL, NULL, '', '', NULL),
('def', 'daral', 'national', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 32768, 11534336, '2013-01-10 15:16:01', NULL, NULL, NULL, '', '', NULL),
('def', 'daral', 'notification', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 7, 2340, 16384, NULL, 98304, 11534336, '2013-01-10 15:16:01', NULL, NULL, NULL, '', '', NULL),
('def', 'daral', 'region', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 14, 1170, 16384, NULL, 16384, 11534336, '2013-01-10 15:14:57', NULL, NULL, NULL, '', '', NULL),
('def', 'daral', 'regionstatanimal', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 49152, 11534336, '2013-01-10 15:16:02', NULL, NULL, NULL, '', '', NULL),
('def', 'daral', 'regionstatfarmer', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 32768, 11534336, '2013-01-10 15:16:02', NULL, NULL, NULL, '', '', NULL),
('def', 'daral', 'roleusers', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 8192, 16384, NULL, 16384, 11534336, '2013-01-10 15:14:58', NULL, NULL, NULL, '', '', NULL),
('def', 'daral', 'typenotification', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 4096, 16384, NULL, 16384, 11534336, '2013-01-10 15:14:58', NULL, NULL, NULL, '', '', NULL),
('def', 'daral', 'users', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 5, 3276, 16384, NULL, 81920, 11534336, '2013-01-10 15:16:02', NULL, NULL, NULL, '', '', NULL),
('def', 'daral', 'veterinaire', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 32768, 11534336, '2013-01-10 15:14:58', NULL, NULL, NULL, '', '', NULL),
...
('def', 'test', 'news', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 0, '2012-12-12 14:42:20', NULL, NULL, NULL, '', '', NULL),
...
('def', 'zf_daral', 'animal', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 8192, 16384, NULL, 16384, 0, '2012-11-28 19:15:51', NULL, NULL, NULL, '', '', NULL),
('def', 'zf_daral', 'daral', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 10, 1638, 16384, NULL, 16384, 0, '2012-11-28 19:15:51', NULL, NULL, NULL, '', '', NULL),
('def', 'zf_daral', 'farmer', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 46, 356, 16384, NULL, 65536, 0, '2012-11-28 20:00:38', NULL, NULL, NULL, '', '', NULL),
('def', 'zf_daral', 'lang', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 0, '2012-11-28 19:15:50', NULL, NULL, NULL, '', '', NULL),
('def', 'zf_daral', 'localite', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 6, 2730, 16384, NULL, 0, 0, '2012-11-28 19:15:50', NULL, NULL, NULL, '', '', NULL),
('def', 'zf_daral', 'maladie', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 0, '2012-11-28 19:15:50', NULL, NULL, NULL, '', '', NULL),
('def', 'zf_daral', 'media', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 32768, 0, '2012-11-28 19:15:51', NULL, NULL, NULL, '', '', NULL),
('def', 'zf_daral', 'notification', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 81920, 0, '2012-11-28 19:15:51', NULL, NULL, NULL, '', '', NULL),
('def', 'zf_daral', 'users', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 8, 2048, 16384, NULL, 16384, 0, '2012-11-28 19:15:50', NULL, NULL, NULL, '', '', NULL),
('def', 'zf_daral', 'veterinaire', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 8192, 16384, NULL, 0, 0, '2012-11-28 19:15:51', NULL, NULL, NULL, '', '', NULL);
...
(422, 'root', 'localhost', 'dbuser', 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST`');
...
('def', 'daral', 'farmer_ibfk_14', 'def', 'daral', 'name', 'NONE', 'RESTRICT', 'RESTRICT', 'farmer', 'localite'),
...
('def', 'daral', 'localite_ibfk_2', 'def', 'daral', 'name', 'NONE', 'CASCADE', 'CASCADE', 'localite', 'region'),
...
('def', 'daral', 'notification_ibfk_18', 'def', 'daral', 'id_farmer', 'NONE', 'RESTRICT', 'RESTRICT', 'notification', 'farmer'),
('def', 'daral', 'notification_ibfk_19', 'def', 'daral', 'PRIMARY', 'NONE', 'RESTRICT', 'RESTRICT', 'notification', 'localite'),
('def', 'daral', 'notification_ibfk_20', 'def', 'daral', 'PRIMARY', 'NONE', 'RESTRICT', 'RESTRICT', 'notification', 'typenotification'),
('def', 'daral', 'notification_ibfk_21', 'def', 'daral', 'PRIMARY', 'NONE', 'RESTRICT', 'RESTRICT', 'notification', 'users'),
...
('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '133801'),
...
('def', 'daral', 'farmer', 0, 'daral', 'PRIMARY', 1, 'rank_farmer', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'daral', 'farmer', 0, 'daral', 'id_farmer', 1, 'id_farmer', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'daral', 'farmer', 1, 'daral', 'categorie', 1, 'categorie', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'daral', 'farmer', 1, 'daral', 'categorie', 2, 'daral_originel', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'daral', 'farmer', 1, 'daral', 'categorie', 3, 'daral_actuel', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'daral', 'farmer', 1, 'daral', 'categorie', 4, 'id_localite', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'daral', 'farmer', 1, 'daral', 'daral_originel', 1, 'daral_originel', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'daral', 'farmer', 1, 'daral', 'daral_actuel', 1, 'daral_actuel', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'daral', 'farmer', 1, 'daral', 'id_localite', 1, 'id_localite', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
...
('def', 'daral', 'localite', 1, 'daral', 'departement', 2, 'region', 'A', 7, NULL, NULL, '', 'BTREE', '', ''),
('def', 'daral', 'localite', 1, 'daral', 'region', 1, 'region', 'A', 7, NULL, NULL, '', 'BTREE', '', ''),
...
('def', 'daral', 'notification', 0, 'daral', 'PRIMARY', 1, 'id', 'A', 7, NULL, NULL, '', 'BTREE', '', ''),
('def', 'daral', 'notification', 1, 'daral', 'id_farmer', 1, 'id_farmer', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'daral', 'notification', 1, 'daral', 'id_farmer', 2, 'id_localite', 'A', 7, NULL, NULL, '', 'BTREE', '', ''),
('def', 'daral', 'notification', 1, 'daral', 'id_farmer', 3, 'type', 'A', 7, NULL, NULL, '', 'BTREE', '', ''),
('def', 'daral', 'notification', 1, 'daral', 'id_farmer', 4, 'id_user', 'A', 7, NULL, NULL, '', 'BTREE', '', ''),
('def', 'daral', 'notification', 1, 'daral', 'id_localite', 1, 'id_localite', 'A', 7, NULL, NULL, '', 'BTREE', '', ''),
('def', 'daral', 'notification', 1, 'daral', 'id_farmer_2', 1, 'id_farmer', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'daral', 'notification', 1, 'daral', 'id_user', 1, 'id_user', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'daral', 'notification', 1, 'daral', 'type', 1, 'type', 'A', 7, NULL, NULL, '', 'BTREE', '', ''),
('def', 'daral', 'notification', 1, 'daral', 'type_2', 1, 'type', 'A', 7, NULL, NULL, '', 'BTREE', '', ''),
...
('def', 'information_schema', 'CHARACTER_SETS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 384, 0, 16434816, 0, 0, NULL, '2013-01-10 15:25:45', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=43690', ''),
('def', 'information_schema', 'COLLATIONS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 231, 0, 16704765, 0, 0, NULL, '2013-01-10 15:25:45', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=72628', ''),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 195, 0, 16357770, 0, 0, NULL, '2013-01-10 15:25:45', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=86037', ''),
('def', 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2013-01-10 15:25:45', '2013-01-10 15:25:45', NULL, 'utf8_general_ci', NULL, 'max_rows=2802', ''),
('def', 'information_schema', 'COLUMN_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2565, 0, 16757145, 0, 0, NULL, '2013-01-10 15:25:45', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6540', ''),
('def', 'information_schema', 'ENGINES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 490, 0, 16574250, 0, 0, NULL, '2013-01-10 15:25:45', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=34239', ''),
('def', 'information_schema', 'EVENTS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2013-01-10 15:25:45', '2013-01-10 15:25:45', NULL, 'utf8_general_ci', NULL, 'max_rows=618', ''),
('def', 'information_schema', 'FILES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2677, 0, 16758020, 0, 0, NULL, '2013-01-10 15:25:45', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6267', ''),
('def', 'information_schema', 'GLOBAL_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2013-01-10 15:25:45', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'GLOBAL_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2013-01-10 15:25:45', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'KEY_COLUMN_USAGE', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4637, 0, 16762755, 0, 0, NULL, '2013-01-10 15:25:45', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3618', ''),
('def', 'information_schema', 'PARAMETERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2013-01-10 15:25:45', '2013-01-10 15:25:45', NULL, 'utf8_general_ci', NULL, 'max_rows=6050', ''),
('def', 'information_schema', 'PARTITIONS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2013-01-10 15:25:45', '2013-01-10 15:25:45', NULL, 'utf8_general_ci', NULL, 'max_rows=5579', ''),
('def', 'information_schema', 'PLUGINS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2013-01-10 15:25:45', '2013-01-10 15:25:45', NULL, 'utf8_general_ci', NULL, 'max_rows=11328', ''),
('def', 'information_schema', 'PROCESSLIST', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2013-01-10 15:25:45', '2013-01-10 15:25:45', NULL, 'utf8_general_ci', NULL, 'max_rows=23899', ''),
('def', 'information_schema', 'PROFILING', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 308, 0, 16562084, 0, 0, NULL, '2013-01-10 15:25:45', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=54471', ''),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4814, 0, 16767162, 0, 0, NULL, '2013-01-10 15:25:45', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3485', ''),
('def', 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2013-01-10 15:25:45', '2013-01-10 15:25:45', NULL, 'utf8_general_ci', NULL, 'max_rows=583', ''),
('def', 'information_schema', 'SCHEMATA', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3464, 0, 16738048, 0, 0, NULL, '2013-01-10 15:25:45', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=4843', ''),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2179, 0, 16736899, 0, 0, NULL, '2013-01-10 15:25:45', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7699', ''),
('def', 'information_schema', 'SESSION_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2013-01-10 15:25:45', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'SESSION_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2013-01-10 15:25:45', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'STATISTICS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 5753, 0, 16752736, 0, 0, NULL, '2013-01-10 15:25:45', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2916', ''),
('def', 'information_schema', 'TABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 9450, 0, 16764300, 0, 0, NULL, '2013-01-10 15:25:45', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=1775', ''),
('def', 'information_schema', 'TABLESPACES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 6951, 0, 16772763, 0, 0, NULL, '2013-01-10 15:25:45', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2413', ''),
('def', 'information_schema', 'TABLE_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2504, 0, 16721712, 0, 0, NULL, '2013-01-10 15:25:45', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6700', ''),
('def', 'information_schema', 'TABLE_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2372, 0, 16748692, 0, 0, NULL, '2013-01-10 15:25:45', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7073', ''),
('def', 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2013-01-10 15:25:45', '2013-01-10 15:25:45', NULL, 'utf8_general_ci', NULL, 'max_rows=569', ''),
('def', 'information_schema', 'USER_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 1986, 0, 16726092, 0, 0, NULL, '2013-01-10 15:25:45', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=8447', ''),
('def', 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2013-01-10 15:25:45', '2013-01-10 15:25:45', NULL, 'utf8_general_ci', NULL, 'max_rows=6935', ''),
('def', 'information_schema', 'INNODB_CMP_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 13107200, 0, 0, NULL, '2013-01-10 15:25:45', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_TRX', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4534, 0, 16766732, 0, 0, NULL, '2013-01-10 15:25:45', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3700', ''),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2013-01-10 15:25:45', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_LOCK_WAITS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 599, 0, 16749238, 0, 0, NULL, '2013-01-10 15:25:45', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=28008', ''),
('def', 'information_schema', 'INNODB_CMPMEM', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2013-01-10 15:25:45', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_CMP', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 13107200, 0, 0, NULL, '2013-01-10 15:25:45', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_LOCKS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 31244, 0, 16746784, 0, 0, NULL, '2013-01-10 15:25:45', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=536', ''),
('def', 'daral', 'animal', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 32768, 11534336, 1, '2013-01-10 15:15:59', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'daral', 'animaltype', 'BASE TABLE', 'InnoDB', 10, 'Compact', 2, 8192, 16384, 0, 16384, 11534336, 3, '2013-01-10 15:14:55', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'daral', 'categorie', 'BASE TABLE', 'InnoDB', 10, 'Compact', 2, 8192, 16384, 0, 16384, 11534336, 3, '2013-01-10 15:14:55', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'daral', 'cheptel', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 32768, 11534336, 1, '2013-01-10 15:15:59', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'daral', 'daral', 'BASE TABLE', 'InnoDB', 10, 'Compact', 7, 2340, 16384, 0, 32768, 11534336, 8, '2013-01-10 15:15:59', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'daral', 'daralstatanimal', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 32768, 11534336, 1, '2013-01-10 15:15:59', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'daral', 'daralstatfarmer', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 16384, 11534336, 1, '2013-01-10 15:16:00', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'daral', 'departement', 'BASE TABLE', 'InnoDB', 10, 'Compact', 45, 364, 16384, 0, 32768, 11534336, 46, '2013-01-10 15:16:00', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'daral', 'departementstatanimal', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 32768, 11534336, 1, '2013-01-10 15:16:00', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'daral', 'departementstatfarmer', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 16384, 11534336, 1, '2013-01-10 15:16:00', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'daral', 'farmer', 'BASE TABLE', 'InnoDB', 10, 'Compact', 3, 5461, 16384, 0, 81920, 11534336, 40, '2013-01-10 15:16:00', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'daral', 'langue', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 16384, 11534336, 1, '2013-01-10 15:14:56', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'daral', 'localite', 'BASE TABLE', 'InnoDB', 10, 'Compact', 7, 2340, 16384, 0, 49152, 11534336, 8, '2013-01-10 15:16:00', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'daral', 'localitestatanimal', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 32768, 11534336, 1, '2013-01-10 15:16:01', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'daral', 'localitestatfarmer', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 16384, 11534336, 1, '2013-01-10 15:16:01', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'daral', 'maladie', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 16384, 11534336, 1, '2013-01-10 15:14:57', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'daral', 'media', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 32768, 11534336, 1, '2013-01-10 15:16:01', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'daral', 'national', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 32768, 11534336, 1, '2013-01-10 15:16:01', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'daral', 'notification', 'BASE TABLE', 'InnoDB', 10, 'Compact', 7, 2340, 16384, 0, 98304, 11534336, 9, '2013-01-10 15:16:01', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'daral', 'region', 'BASE TABLE', 'InnoDB', 10, 'Compact', 14, 1170, 16384, 0, 16384, 11534336, 15, '2013-01-10 15:14:57', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'daral', 'regionstatanimal', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 49152, 11534336, 1, '2013-01-10 15:16:02', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'daral', 'regionstatfarmer', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 32768, 11534336, 1, '2013-01-10 15:16:02', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'daral', 'roleusers', 'BASE TABLE', 'InnoDB', 10, 'Compact', 2, 8192, 16384, 0, 16384, 11534336, 3, '2013-01-10 15:14:58', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'daral', 'typenotification', 'BASE TABLE', 'InnoDB', 10, 'Compact', 4, 4096, 16384, 0, 16384, 11534336, 5, '2013-01-10 15:14:58', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'daral', 'users', 'BASE TABLE', 'InnoDB', 10, 'Compact', 5, 3276, 16384, 0, 81920, 11534336, 6, '2013-01-10 15:16:02', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'daral', 'veterinaire', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 32768, 11534336, 1, '2013-01-10 15:14:58', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
...
('def', 'daral', 'farmer_ibfk_14', 'daral', 'farmer', 'FOREIGN KEY'),
...
('def', 'daral', 'localite_ibfk_2', 'daral', 'localite', 'FOREIGN KEY'),
...
('def', 'daral', 'notification_ibfk_18', 'daral', 'notification', 'FOREIGN KEY'),
('def', 'daral', 'notification_ibfk_19', 'daral', 'notification', 'FOREIGN KEY'),
('def', 'daral', 'notification_ibfk_20', 'daral', 'notification', 'FOREIGN KEY'),
('def', 'daral', 'notification_ibfk_21', 'daral', 'notification', 'FOREIGN KEY'),
