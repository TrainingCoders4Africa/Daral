 ...
 * @version $Id$
 *
 * @method Application_Model_Categorie_Row createRow(array $data, string $defaultSource = null)
 * @method Application_Model_Categorie_Rowset fetchAll(string|array|Zend_Db_Table_Select $where = null, string|array $order = null, int $count = null, int $offset = null)
 * @method Application_Model_Categorie_Row fetchRow(string|array|Zend_Db_Table_Select $where = null, string|array $order = null, int $offset = null)
 * @method Application_Model_Categorie_Rowset find()
 *
 */
abstract class Application_Model_Categorie_DbTable_Abstract extends Zend_Db_Table_Abstract
{
    /**
     * @var string
     */
  ...
  0 => 'Application_Model_Farmer_DbTable',
);
     ...
     * @var string
     */
    protected $_rowClass = 'Application_Model_Categorie_Row';

    /**
     * @var string
     */
    protected $_rowsetClass = 'Application_Model_Categorie_Rowset';
  ...
  'max_animal' => NULL,
    ...
    public function getDbSelectByParams($params = array(), $sortField = '', $sortOrder = '')
    {
        ...
        if (isset($params['categorie_id']) && !empty($params['categorie_id'])) {
            $select->where('categorie_id = ?', $params['categorie_id']);
        }

        if (isset($params['max_animal']) && !empty($params['max_animal'])) {
            $select->where('max_animal = ?', $params['max_animal']);
        }
